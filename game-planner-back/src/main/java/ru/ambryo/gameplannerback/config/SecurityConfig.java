    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/swagger-ui/**", "/api/swagger-ui.html").permitAll() // Swagger UI доступен всем для ввода токена
                ...
                .requestMatchers("/api/api-docs/**").hasRole("ADMIN") // OpenAPI JSON/YAML спецификация - только для администраторов
