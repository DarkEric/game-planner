...
- **OpenAPI JSON спецификация**: http://localhost:8080/api-docs
- **OpenAPI YAML спецификация**: http://localhost:8080/api-docs.yaml
...
```bash
curl -H "Authorization: Bearer <admin_jwt_token>" http://localhost:8080/api-docs > openapi.json
```
